    ...
    <div ref={wrapRef} className="relative sm:w-60">
      ...
      >
        ...
        <svg
          ...
          className={`pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-black/50 dark:text-white/50 transition-transform duration-200 ${open ? "rotate-180" : ""}`}
        >
          <path d="m6 9 6 6 6-6" />
        </svg>
      </button>
      ...
      {open && (
          <ul
            role="listbox"
            className="animate-ui-scale-in absolute z-50 mt-2 w-full overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-white/95 dark:bg-black/95 backdrop-blur-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.25)] dark:shadow-[0_20px_60px_-15px_rgba(255,46,136,0.25)] p-1.5"
          >
            {options.map((opt) => {
...
function ProductsPageContent({ products, categories }) {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-white dark:bg-black transition-colors duration-500">
      {/* Background glows */}
      ...
      <section className="relative pt-24 sm:pt-32 pb-10 sm:pb-12 px-4 sm:px-6">
        <div className="relative max-w-6xl mx-auto text-center">
          <p className="animate-ui-fade-in-up text-[#FF4DA3] text-xs tracking-[0.4em] uppercase">
            ● The Full Collection
          </p>
          <h1
            className="animate-ui-fade-in-up text-black dark:text-white text-4xl sm:text-5xl md:text-7xl font-[1000] mt-4 leading-[0.9] tracking-tighter uppercase"
          ...
          <p
            className="animate-ui-fade-in-up text-black/60 dark:text-white/50 max-w-xl mx-auto mt-6 text-sm md:text-base"
          ...
          <div
            className="animate-ui-fade-in-up flex items-center justify-center gap-3 text-[10px] uppercase tracking-[0.3em] font-bold text-black/40 dark:text-white/30 mt-6"
      ...
      <section className="relative z-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div
            className="animate-ui-fade-in-up flex flex-col gap-4 p-4 sm:p-5 rounded-2xl bg-gradient-to-b from-black/[0.03] to-transparent dark:from-white/[0.04] dark:to-transparent border border-black/10 dark:border-white/10 backdrop-blur-sm"
      ...
      {/* Grid */}
      <section ref={gridRef} className="relative z-10 px-4 sm:px-6 pb-24 scroll-mt-28">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 min-h-[300px]">
              {visibleProducts.length > 0 ? (
                ...
                <div
                  key="empty"
                  className="fade-in-view col-span-full py-20 text-center flex flex-col items-center gap-4"
                >
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="animate-ui-fade-in-up mt-14 flex flex-col items-center gap-4">
