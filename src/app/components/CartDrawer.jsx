          ...
          >
              ...
              {cart.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-black/50 dark:text-white/40 font-light">
                    Your bag is looking a bit light...
                  </p>
                  <button
                    onClick={() => setIsCartOpen(false)}
                    ...
                    {cart.map((item) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="group relative flex gap-4 bg-black/[0.03] dark:bg-white/[0.03] hover:bg-black/[0.06] dark:hover:bg-white/[0.06] border border-black/10 dark:border-white/5 p-3 rounded-2xl transition-all duration-300"
                        >
                            ...
                            <div>
                              <div className="flex justify-between items-start gap-2">
                                ...
                                <button
                                  ...
                                  className="text-black/30 dark:text-white/30 hover:text-red-400 transition-colors"
                                >
                                  <Trash2 size={16} />
                                </button>
                              </div>
                            ...
                            <div className="flex items-end justify-between mt-2">
                              <div className="flex items-center bg-black/5 dark:bg-black/40 rounded-lg border border-black/10 dark:border-white/5">
                                <button
                                  ...
                                  aria-label="Decrease"
                                  className="w-8 h-8 grid place-items-center text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5 rounded-l-lg transition"
                                >
                                  <Minus size={13} />
                                </button>
                                <span className="w-8 text-center text-black dark:text-white/90 text-sm font-medium">
                                  {item.quantity}
                                </span>
                                <button
                                  onClick={() =>
            ...
            {cart.length > 0 && (
              ...
              >
                ...
                <button className="relative group w-full bg-[#FF4DA3] overflow-hidden text-white py-4 rounded-xl font-bold transition-all hover:shadow-[0_0_30px_-5px_#FF4DA3]">
